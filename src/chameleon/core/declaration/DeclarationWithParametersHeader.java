...
/**
 * A class of objects representing method headers. A method header contains for
 * example the name and parameters of a method.
 * 
...
public abstract class DeclarationWithParametersHeader<E extends DeclarationWithParametersHeader, P extends NamespaceElement, S extends DeclarationWithParametersSignature>
	...
	/**
	 * Return the signature of the method of this method header. The signature
	 * is generated based on the information in the header.
	 * 
	 * @return
	 */
	...
	/**
	 * The children of a method header are its formal parameters and the type
	 * parameter block.
	 */
	/*
	 * @
	...
	public void addFormalParameters(List<FormalParameter> arg) {
		if (arg == null)
			return;

		for (FormalParameter p : arg)
	...
	private OrderedMultiAssociation<DeclarationWithParametersHeader, FormalParameter> _parameters = new OrderedMultiAssociation<DeclarationWithParametersHeader, FormalParameter>(
			this);
	...
	// /**
	// * Check whether or not this method contains a formal parameter with the
	// given name.
	// *
	// * @param name
	...
	// @ public behavior
	// @
	// @ post \result == (\exists FormalParameter fp;
	// getFormalParameters.contains(fp);
	...
	/**
	 * The declarations of a method header are its formal parameters and its
	 * type parameters.
	 */
	/*
	 * @
	...
	public boolean sameParameterTypesAs(MethodHeader other)
			throws ModelException {
	...
	// public LookupStrategy lexicalLookupStrategy(Element element) {
	// return
	// language().lookupFactory().createLexicalLookupStrategy(language().lookupFactory().createLocalLookupStrategy(this),this);
	// }

	private SingleAssociation<DeclarationWithParametersHeader, TypeParameterBlock> _typeParameters = new SingleAssociation<DeclarationWithParametersHeader, TypeParameterBlock>(
			this);
	...
	public List<TypeParameter> typeParameters() {
		...
		return (parameterBlock == null ? new ArrayList<TypeParameter>()
	...
	public void replaceTypeParameter(TypeParameter oldParameter,
